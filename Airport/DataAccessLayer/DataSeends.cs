...
namespace DataAccessLayer
{
    public static class DataSeends
    {
        ...
        {
            new Ticket(){Id = id1,FlightId = 1,Price = 5000},
            new Ticket(){Id = id2,FlightId = 2,Price = 3500}
        };
        
        public static List<Flight> Flights = new List<Flight>()
        {
            
            new Flight(){Id = id1,Departure = "Kiev",DepartureTime = new DateTime(2018,7,15,19,35,00),
                Destination = "Tbilisi",ArrivalTime = new DateTime(2018,7,15,21,52,00),
                Tickets = Tickets.Where(t=>t.FlightId==id1).ToList()},
            new Flight(){Id = id2,Departure = "Venezia",DepartureTime = new DateTime(2018,7,17,13,25,00),
                Destination = "Kiev",ArrivalTime = new DateTime(2018,7,17,16,00,00),
                Tickets = Tickets.Where(t=>t.FlightId==id2).ToList()
            }
        };
